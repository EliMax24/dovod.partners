      ...
      <div className="container-pp">
        <Reveal>
          <div className="flex items-baseline justify-between gap-8 mb-16 md:mb-24">
            <h2 className="font-display font-medium text-display-md max-w-3xl">Как мы работаем</h2>
            <div className="hidden md:block text-sm text-paper/50">03 / 05</div>
          </div>
        </Reveal>
          ...
          {approach.map((s, i) => (
            <Reveal key={s.num} delay={i * 0.1}>
              <div className="flex flex-col h-full border-t border-paper/20 pt-6">
                <div className="font-display text-paper/40 text-sm mb-8">{s.num}</div>
