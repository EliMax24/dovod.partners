      ...
      <div className="container-pp">
        <Reveal>
          <div className="flex items-baseline justify-between gap-8 mb-16 md:mb-24">
            <h2 className="font-display font-medium text-display-md max-w-3xl">Экспертиза</h2>
            <div className="hidden md:block text-sm text-muted">02 / 05</div>
          </div>
        </Reveal>
          ...
          {expertise.map((e, i) => (
            <Reveal key={e.num} delay={i * 0.06}>
              <div className="grid grid-cols-1 md:grid-cols-[90px_1fr_2fr] gap-6 md:gap-10 py-10 md:py-14 border-b border-line-strong">
                <div className="font-display text-muted text-sm tabular-nums">
                  {e.num} / 04
                </div>
